...
#    output_script=$script_dir/modified_bowtie_script_$sample_job.txt
#    sed "s:$template_job:$sample_job:g" |  
#    sed "s:$template_fastq:$sample_fastq:g" | tr -d '\r' > $output_script
